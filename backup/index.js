...
function update(){
    ...
    if (!playerDead)  {
     ...
     else if ((cursors.left.isDown||(this.input.pointer1.isDown && this.input.pointer1.x<window.innerWidth/2)&&!(this.input.pointer1.x===0)) && !cursors.right.isDown && !this.input.pointer2.isDown&& !spacebar.isDown && !playerDead)
      {
      ...
      else if(!(cursors.right.isDown || (this.input.pointer1.x>window.innerWidth/2 && this.input.pointer1.isDown && !this.input.pointer2.isDown)) && !(cursors.left.isDown || (this.input.pointer1.x<window.innerWidth/2 && this.input.pointer1.x!==0 && this.input.pointer1.isDown)) && !spacebar.isDown && !playerDead){
          // player.anims.play('still', true);
          // console.log('idle')
          player.anims.play('still', true);
            
      }
      else if(spacebar.isDown||(this.input.pointer1.isDown && this.input.pointer2.isDown) ){
